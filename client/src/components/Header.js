...
export default function Header() {
    const timeConvert=(date)=>{
        let temp=`${date.getHours()}:${date.getMinutes()}`;
        return temp
    }
    let date= new Date();
    ...
    return (
        <>
            <div className="header">
                <div className="logo">Moni <span className="logo-det" >tre</span></div>
                <div className="user-info">
                    <div className="user-name">Arish</div>
                    ...
                    <div className="hour">{timeConvert(new Date())}</div>
                </div>
            </div>
        </>
    )
